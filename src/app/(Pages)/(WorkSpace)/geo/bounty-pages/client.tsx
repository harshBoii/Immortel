      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">GEO · Bounty</p>
          </div>
              ...
              >
                ...
                <div className="border-t border-[var(--glass-border)]/50 bg-[var(--glass)]/30 px-5 py-3 flex flex-wrap items-center gap-2">
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 rounded-lg bg-[var(--sibling-primary)] px-3.5 py-1.5 text-[11px] font-semibold text-white hover:opacity-90 active:scale-[0.98] transition-all"
                  >
